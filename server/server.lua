...
-- bossmenu storage
---------------------------------
RegisterNetEvent('rsg-bossmenu:server:openstash', function(stash)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
    if not Player then return end
    local data = { label = 'Boss Storage', maxweight = Config.StorageMaxWeight, slots = Config.StorageMaxSlots }
